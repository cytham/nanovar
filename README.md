...
Although NanoVar is provided with a universal model and threshold score, instructions and scripts required for building a custom neural-network model is available [here](./scripts/NNtrain_tutorial.md).
