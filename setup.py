...
setup(
    ...
    install_requires=['numpy>=1.17.3', 'scipy>=1.2.1', 'biopython>=1.74', 'pybedtools>=0.8.2', 'matplotlib>=2.2.3',
                      'tensorflow-cpu>=2.0.0', 'natsort>=6.2.0', 'progress>=1.4', 'pysam>=0.15.3', 'cytocad>=1.0.2', 'htmlark>=1.0.0'],
    python_requires='>=3.6',
    classifiers=[
